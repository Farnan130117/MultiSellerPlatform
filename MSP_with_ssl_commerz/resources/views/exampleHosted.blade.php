        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation"> 
               ...
               <input type="hidden" value="{{ csrf_token() }}" name="_token" /> 
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="shipping_fullname" class="form-control" id="shipping_fullname" placeholder=""
                               value="Mr. X" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="shipping_phone" class="form-control" id="shipping_phone" placeholder="Mobile"
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="shipping_email" class="form-control" id="shipping_email"
                ...
                <div class="row">
                    <div class="col-md-5 mb-3">
                        ...
                        <select name="shipping_state" class="custom-select d-block w-100" id="shipping_state" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="shipping_city" class="custom-select d-block w-100" id="shipping_city" required>
                            <option value="">Choose...</option>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input name="shipping_zipcode" type="text" class="form-control" id="zip" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
                ...
                <div class="form-check">
                <label class="form-check-label">
                <input type="radio" class="form-check-input" name="payment_method" id="" value="ssl_commerz">
                SSL-COMMERZ
                </label>
                </div>
                <!--
               ...
               -->
                ...
                <!--
                <div>
                    <input type="text" value= {{\Cart::session(auth()->id())->getTotal()}} readonly>
                </div>
               -->
            </form>
